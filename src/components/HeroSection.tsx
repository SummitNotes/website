...
const HeroSection: React.FC<HeroSectionProps> = ({
  ...
  description = "Record, transcribe, and summarize with AI that runs on your device. Works with all meeting apps. No cloud uploads. No meeting bots. Your data stays yours.",
