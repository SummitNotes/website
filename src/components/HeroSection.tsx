...
const HeroSection: React.FC<HeroSectionProps> = ({
  ...
  description = "Record online and in-person meetings privately. Get searchable transcripts and client-ready summaries locally on your Mac.",
  ctaText = "Try 15 Recordings Free",
}) => {
