...
import { CheckCircle, ArrowRight, Mail, Sparkles, Bell, Zap, AlertCircle } from 'lucide-react';
...
interface MailingListSignupProps {
  ...
  title?: string;
  subtitle?: string;
  source?: string; // Which page the signup is from
}
...
const MailingListSignup: React.FC<MailingListSignupProps> = ({
  ...
  subtitle = "Stay updated on Summit AI Notes features, tips, and announcements",
  source = 'homepage'
}) => {
  ...
  const benefits = [
    {
      ...
      text: "Product updates and launch announcements"
    },
    {
      icon: <Zap className="w-5 h-5 text-blue-600" />,
      text: "Productivity tips and best practices"
    },
    {
      icon: <Sparkles className="w-5 h-5 text-green-600" />,
      text: "Exclusive content and early feature previews"
    }
  ];
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const response = await fetch('https://n8n.seniorsoftwarevlogger.com/webhook/d6455b3b-1e0e-4b4b-a96c-a9d6de47a3f5', {
        method: 'POST',
        headers: {
      ...
      console.error('Failed to join mailing list:', error);
                      ...
                      <div className="flex flex-col items-center gap-3">
                        ...
                        <div className="text-center">
                          ...
                          <p className="text-sm text-green-700">
                            Check your email for confirmation. We'll keep you updated.
                          </p>
                        </div>
                      </div>
                    </div>
